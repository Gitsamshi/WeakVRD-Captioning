...
def parse_opt():
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="vrgmodel",
                    help='model type: [vrgmodel]')
    ...
    parser.add_argument('--vrg_data_dir', type=str, default='data/coco_cmb_vrg_final',
